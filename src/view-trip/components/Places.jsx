                  ...
                  <div className="p-6 flex flex-col justify-between flex-1">
                    <div className="flex flex-col gap-3">
                      ...
                      <p className="text-sm text-gray-600 line-clamp-3">
                        {place.placeDetails || place.PlaceDetails || place["Place Details"]}
                      </p>

                      {/* Travel Info Badges */}
                      <div className="flex flex-wrap gap-3 text-sm mt-2">
                        <span className="bg-gray-100 px-3 py-1 rounded-full">
                          ⏰ {place.best_time_to_visit || place.BestTimeToVisit || place.bestTimeToVisit || place["best time to visit"]}
                        </span>
                        <span className="bg-gray-100 px-3 py-1 rounded-full">
                          🕒 {place.timeTravel || place.TimeTravel || place["Time travel"]}
                        </span>
                        <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full font-medium">
                          🎟 {place.ticketPricing || place.ticketPricing || place.TicketPricing || place["ticket Pricing"]}
                        </span>
                      </div>
                    </div>
